...
function CartDrawer() {
  ...
  const categoryImage: Record<string, string> = {
    Rings: imagePath('ring.jpg'),
    Necklaces: imagePath('necklace.jpg'),
    Bracelets: imagePath('bracelet.jpg'),
    Earrings: imagePath('earrings.jpg'),
  };
  ...
  const handleApplyPromo = () => {
    ...
    if (code === 'VISION10') {
      ...
      setPromoMessage('VISION10 applied.');
      return;
    }
              ...
              {step === 'confirm' && (
                <div className="space-y-5">
                  ...
                  <div className="space-y-2 pt-2">
                    ...
                    {discount > 0 && (
                      <div className="flex justify-between text-xs">
                        <span className="text-dark-500">Promo (VISION10)</span>
...
function ProductDetailModal() {
  ...
  const categoryImages: Record<string, { src: string; label: string; bgPos: string; bgSize: string }[]> = {
    Rings: [
      { src: imagePath('ring.jpg'), label: 'Front', bgPos: 'center', bgSize: 'cover' },
      { src: imagePath('ring-side.jpg'), label: 'Profile', bgPos: 'center', bgSize: 'cover' },
      { src: imagePath('ring.jpg'), label: 'Detail', bgPos: 'center 35%', bgSize: '220%' },
    ],
    Necklaces: [
      { src: imagePath('necklace.jpg'), label: 'Front', bgPos: 'center', bgSize: 'cover' },
      { src: imagePath('necklace-side.jpg'), label: 'Side', bgPos: 'center', bgSize: 'cover' },
      { src: imagePath('necklace.jpg'), label: 'Detail', bgPos: 'center 30%', bgSize: '220%' },
    ],
    Bracelets: [
      { src: imagePath('bracelet.jpg'), label: 'Front', bgPos: 'center', bgSize: 'cover' },
      { src: imagePath('bracelet-side.jpg'), label: 'Side', bgPos: 'center', bgSize: 'cover' },
      { src: imagePath('bracelet.jpg'), label: 'Detail', bgPos: 'center 40%', bgSize: '220%' },
    ],
    Earrings: [
      { src: imagePath('earrings.jpg'), label: 'Front', bgPos: 'center', bgSize: 'cover' },
      { src: imagePath('earrings-side.jpg'), label: 'Side', bgPos: 'center', bgSize: 'cover' },
      { src: imagePath('earrings.jpg'), label: 'Detail', bgPos: 'center 35%', bgSize: '220%' },
    ],
  };
...
function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-center gap-10">
        <Link
          to="/"
          className="font-serif text-2xl md:text-3xl tracking-[0.3em] text-gold-500 font-semibold hover:opacity-90 transition-opacity shrink-0"
        >
          VISION WRLD
          </Link>
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="relative z-10 text-center px-6 max-w-4xl">
        ...
        <motion.p
          ...
          className="text-dark-300 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-light"
        >
        ...
        >
          <Link
            to="/collection"
            className="bg-gold-500 text-dark-900 px-8 py-4 text-sm tracking-widest uppercase font-semibold flex items-center gap-3 hover:bg-gold-400 transition-colors"
          ...
          <Link
            to="/contact"
            className="border border-gold-500/40 text-gold-500 px-8 py-4 text-sm tracking-widest uppercase font-semibold hover:bg-gold-500/10 transition-colors"
            style={{ display: 'inline-flex' }}
          >
            Book Appointment
          </Link>
        ...
        <div className="relative aspect-square overflow-hidden">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2 z-10">
            {item.isNew && (
              <motion.span
                ...
                className="bg-gold-500 text-dark-900 text-[10px] tracking-widest uppercase px-3 py-1 font-semibold"
              >
                New
              </motion.span>
            )}
          ...
          <div className="absolute top-3 right-3 flex flex-col gap-2 z-10">
            <motion.button
              ...
              className={`w-9 h-9 backdrop-blur-sm flex items-center justify-center transition-all duration-200 border ${
                liked
          ...
          >
            <motion.button
              ...
              className={`w-full py-3 text-xs tracking-widest uppercase font-semibold flex items-center justify-center gap-2 transition-all duration-300 ${
                added
                  ? 'bg-green-500 text-white'
                  : 'bg-gold-500 text-dark-900 hover:bg-gold-400'
              }`}
        ...
        <div className="p-4">
          <div className="flex items-center justify-between mb-1">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-dark-400 text-xs">{item.rating}</span>
            </div>
          </div>
                    ...
                    {foundOrder.items.map((item, idx) => (
                      <div key={idx} className="flex gap-3">
                        <div
                          ...
                          style={{ backgroundImage: `url(${categoryImage[item.category] || imagePath('hero.jpg')})` }}
                        />
                        <div className="flex-1 min-w-0">
